import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function UseState() {
    return (
      ...
      <AlertBox type="warning" title="Nunca mute objetos">React detecta mudança por referência. <code>user.idade++</code> NÃO dispara re-render. Sempre crie novo objeto/array.</AlertBox>
      </PageContainer>
    );
  }

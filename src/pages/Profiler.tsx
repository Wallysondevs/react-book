import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function Profiler() {
    return (
      ...
      <AlertBox type="info" title="Highlight updates">Em DevTools settings, ative 'Highlight updates when components render' — você vê visualmente cada re-render piscando.</AlertBox>
      </PageContainer>
    );
  }

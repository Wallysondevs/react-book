import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function UseRef() {
    return (
      ...
      <AlertBox type={"info"} title={"useRef ≠ useState"}><span dangerouslySetInnerHTML={{__html: "Mudar <code>.current</code> NÃO re-renderiza. Use só para coisas que não devem disparar atualização."}} /></AlertBox>
      </PageContainer>
    );
  }

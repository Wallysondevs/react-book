import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function Hoc() {
    return (
      ...
      <AlertBox type={"info"} title={"Hoje em dia"}><span dangerouslySetInnerHTML={{__html: "Hooks substituíram a maioria dos casos de uso de HOCs. Use HOCs só quando precisar envolver a árvore (ex: error boundaries)."}} /></AlertBox>
      </PageContainer>
    );
  }

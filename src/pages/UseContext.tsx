import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function UseContext() {
    return (
      ...
      <AlertBox type="warning" title="Performance">Toda mudança no value re-renderiza TODOS os consumers. Para estado complexo que muda muito, use Zustand/Redux em vez de Context.</AlertBox>
      </PageContainer>
    );
  }

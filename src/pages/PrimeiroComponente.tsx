import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function PrimeiroComponente() {
    return (
      ...
      <AlertBox type={"success"} title={"Tudo é função"}><span dangerouslySetInnerHTML={{__html: "Em React moderno, um componente é só uma função que retorna JSX. Esqueça classes — hooks tornaram-nas obsoletas."}} /></AlertBox>
      </PageContainer>
    );
  }

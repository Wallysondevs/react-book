import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function ReactTestingLibrary() {
    return (
      ...
      <AlertBox type={"info"} title={"Use roles, não classes"}><span dangerouslySetInnerHTML={{__html: "Sempre prefira <code>getByRole</code>, <code>getByLabelText</code>, <code>getByText</code> — testa acessibilidade junto."}} /></AlertBox>
      </PageContainer>
    );
  }

import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function ReactHookForm() {
    return (
      ...
      <AlertBox type="success" title="Por que escolher">Não causa re-render a cada digitação (uncontrolled internamente). Performance excepcional em forms grandes.</AlertBox>
      </PageContainer>
    );
  }

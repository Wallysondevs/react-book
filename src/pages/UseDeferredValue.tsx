import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function UseDeferredValue() {
    return (
      ...
      <AlertBox type={"info"} title={"Diferença para useTransition"}><span dangerouslySetInnerHTML={{__html: "useTransition envolve a action; useDeferredValue espera o valor estabilizar antes de propagar."}} /></AlertBox>
      </PageContainer>
    );
  }

import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function CreateVite() {
    return (
      ...
      <AlertBox type={"info"} title={"Por que Vite?"}><span dangerouslySetInnerHTML={{__html: "É 10–100× mais rápido que Webpack em dev. Foi adotado pela comunidade React (CRA foi descontinuado em 2023)."}} /></AlertBox>
      </PageContainer>
    );
  }

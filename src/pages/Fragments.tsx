import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function Fragments() {
    return (
      ...
      <AlertBox type="info" title="Por que existem">HTML semântico (table, dl, etc) precisa de filhos diretos específicos. Sem Fragment, um div extra quebraria o layout.</AlertBox>
      </PageContainer>
    );
  }

import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function UseCallback() {
    return (
      ...
      <AlertBox type="info" title="Em 2026 use o React Compiler">O novo compilador adiciona useMemo/useCallback automaticamente. Vai tornar essas APIs quase desnecessárias para a maioria dos casos.</AlertBox>
      </PageContainer>
    );
  }

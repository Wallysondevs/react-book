import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function ReactCompiler() {
    return (
      ...
      <AlertBox type="success" title="Game changer">Você escreve código limpo, o compiler faz a otimização. É um dos avanços mais empolgantes do React em anos.</AlertBox>
      </PageContainer>
    );
  }

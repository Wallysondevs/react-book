import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function KeysDeep() {
    return (
      ...
      <AlertBox type="info" title="Truque útil">Quando você quer descartar todo o estado interno de uma sub-árvore, simplesmente mude a key. Mais limpo que limpar estado manualmente.</AlertBox>
      </PageContainer>
    );
  }

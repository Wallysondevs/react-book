import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function CssModules() {
    return (
      ...
      <AlertBox type={"info"} title={"Suporte nativo"}><span dangerouslySetInnerHTML={{__html: "Vite suporta CSS Modules out-of-the-box — basta nomear o arquivo .module.css."}} /></AlertBox>
      </PageContainer>
    );
  }

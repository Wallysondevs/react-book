import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function Zustand() {
    return (
      ...
      <AlertBox type="success" title="Por que muita gente ama">API absurdamente simples, performance excelente, funciona fora de componentes, suporte a TypeScript impecável.</AlertBox>
      </PageContainer>
    );
  }

import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function Msw() {
    return (
      ...
      <AlertBox type={"success"} title={"Por que adorei"}><span dangerouslySetInnerHTML={{__html: "Você não muda código de produção pra testar. Mock está no nível da rede — funciona com axios, fetch, react-query, qualquer coisa."}} /></AlertBox>
      </PageContainer>
    );
  }

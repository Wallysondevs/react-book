import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function UseReducer() {
    return (
      ...
      <AlertBox type="info" title="Quando usar">Quando tem várias operações relacionadas no mesmo estado, ou quando próximo estado depende do atual de forma complexa.</AlertBox>
      </PageContainer>
    );
  }

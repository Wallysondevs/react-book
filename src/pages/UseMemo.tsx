import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function UseMemo() {
    return (
      ...
      <AlertBox type="warning" title="Não otimize prematuramente">useMemo tem custo (comparação de deps + memória). Use só quando o cálculo é provadamente caro ou para estabilizar referências.</AlertBox>
      </PageContainer>
    );
  }

import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function ContextApi() {
    return (
      ...
      <AlertBox type={"warning"} title={"Para estado que muda muito, considere Zustand"}><span dangerouslySetInnerHTML={{__html: "Context re-renderiza tudo a cada mudança — ruim para estado de alta frequência."}} /></AlertBox>
      </PageContainer>
    );
  }

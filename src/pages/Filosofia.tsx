import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function Filosofia() {
    return (
      ...
      <AlertBox type="success" title="Por que importa">Código declarativo é mais previsível, testável e composável. Bugs raros de sincronização DOM↔estado simplesmente desaparecem.</AlertBox>
      </PageContainer>
    );
  }

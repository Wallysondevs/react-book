import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function UseTransition() {
    return (
      ...
      <AlertBox type="success" title="Concurrent React">Permite que React priorize updates urgentes (digitação) sobre lentos (renderizar lista filtrada de 10k items).</AlertBox>
      </PageContainer>
    );
  }

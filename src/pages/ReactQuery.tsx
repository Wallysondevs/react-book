import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function ReactQuery() {
    return (
      ...
      <AlertBox type="success" title="Padrão de fato">Em 2026, React Query é a forma de fazer data fetching em SPAs React. Resolve 80% dos problemas que pessoas usavam Redux pra resolver.</AlertBox>
      </PageContainer>
    );
  }

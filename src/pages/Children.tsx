import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function Children() {
    return (
      ...
      <AlertBox type={"success"} title={"Composição > configuração"}><span dangerouslySetInnerHTML={{__html: "Use children sempre que possível. É mais flexível que arrays de objetos como props."}} /></AlertBox>
      </PageContainer>
    );
  }

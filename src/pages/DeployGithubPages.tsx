import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function DeployGithubPages() {
    return (
      ...
      <AlertBox type="info" title="Hash routing">Use hash routing (<code>#/rota</code>) para evitar problemas de 404 em refresh — ou adicione um arquivo <code>404.html</code>.</AlertBox>
      </PageContainer>
    );
  }

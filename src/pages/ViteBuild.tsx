import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function ViteBuild() {
    return (
      ...
      <AlertBox type={"success"} title={"Otimizações automáticas"}><span dangerouslySetInnerHTML={{__html: "Tree-shaking, minificação, code-splitting por dynamic import — tudo ligado por padrão."}} /></AlertBox>
      </PageContainer>
    );
  }

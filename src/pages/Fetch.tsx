import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function Fetch() {
    return (
      ...
      <AlertBox type="success" title="Para qualquer projeto sério">Use React Query ou SWR — eles cuidam de cache, retry, refetch e estado de loading/error pra você.</AlertBox>
      </PageContainer>
    );
  }

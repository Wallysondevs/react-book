import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function RenderProps() {
    return (
      ...
      <AlertBox type={"info"} title={"Substituído por hooks"}><span dangerouslySetInnerHTML={{__html: "Em 2026, custom hooks resolvem 99% dos casos onde antes você usaria render props."}} /></AlertBox>
      </PageContainer>
    );
  }

import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function Memo() {
    return (
      ...
      <AlertBox type={"warning"} title={"Não use no escuro"}><span dangerouslySetInnerHTML={{__html: "memo tem custo de comparação. Só use quando profiler mostrar re-renders desnecessários custosos."}} /></AlertBox>
      </PageContainer>
    );
  }

import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function ServerComponents() {
    return (
      ...
      <AlertBox type={"success"} title={"Por que importam"}><span dangerouslySetInnerHTML={{__html: "Você acessa banco direto sem expor APIs. Bundle mínimo, performance excelente."}} /></AlertBox>
      </PageContainer>
    );
  }

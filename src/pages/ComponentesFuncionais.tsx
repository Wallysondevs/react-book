import { PageContainer } from "@/components/layout/PageContainer";
  ...
  export default function ComponentesFuncionais() {
    return (
      ...
      <AlertBox type={"warning"} title={"Esqueça class components"}><span dangerouslySetInnerHTML={{__html: "Eles ainda funcionam por compatibilidade, mas não há motivo para criá-los em código novo."}} /></AlertBox>
      </PageContainer>
    );
  }
